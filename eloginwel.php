...
<body>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="myprofile.php?id=<?php echo $id?>"">mes profil</a></li>
				<li><a class="homeblack" href="empproject.php?id=<?php echo $id?>"">mes taches</a></li>
	...
	<div>
		<!-- <h2>Welcome <?php echo "$empName"; ?> </h2> -->
		    	...
		    	<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">classement des employer </h2>
    	<table>
  ...
  color: white;">Name</th>
		...
		<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">Salair</h2>
    	...
    	<table>
			...
			<tr>
				...
				<th align = "center"style=" background-color: aqua;
  color: white;">Base Salary</th>
				<th align = "center"style=" background-color: aqua;
  color: white;">Bonus</th>
				<th align = "center"style=" background-color: aqua;
  color: white;">Total Salary</th>
